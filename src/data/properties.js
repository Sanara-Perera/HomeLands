...
export const propertiesData = [
  ...
  },
  {
    ...
    images: [
      ...
      `${process.env.PUBLIC_URL}/images/image12.jpg`,
      `${process.env.PUBLIC_URL}/images/image13.jpg`,
      `${process.env.PUBLIC_URL}/images/image14.jpg`,
      `${process.env.PUBLIC_URL}/images/image15.jpg`,
      `${process.env.PUBLIC_URL}/images/image16.jpg`,
    ],
    floorPlan: `${process.env.PUBLIC_URL}/images/image17.jpg`
  },
  {
    id: 3,
    type: 'house',
    ...
    images: [
      `${process.env.PUBLIC_URL}/images/image18.jpg`,
      `${process.env.PUBLIC_URL}/images/image19.jpg`,
      `${process.env.PUBLIC_URL}/images/image20.jpg`,
      `${process.env.PUBLIC_URL}/images/image21.jpg`,
      `${process.env.PUBLIC_URL}/images/image22.jpg`,
      `${process.env.PUBLIC_URL}/images/image23.jpg`,
      `${process.env.PUBLIC_URL}/images/image24.jpg`,
      `${process.env.PUBLIC_URL}/images/image25.jpg`
    ],
    floorPlan: `${process.env.PUBLIC_URL}/images/image26.jpg`
  },
  {
    id: 4,
    type: 'flat',
    ...
    images: [
      `${process.env.PUBLIC_URL}/images/image27.jpg`,
      `${process.env.PUBLIC_URL}/images/image28.jpg`,
      `${process.env.PUBLIC_URL}/images/image29.jpg`,
      `${process.env.PUBLIC_URL}/images/image30.jpg`,
      `${process.env.PUBLIC_URL}/images/image31.jpg`,
      `${process.env.PUBLIC_URL}/images/image32.jpg`,
      `${process.env.PUBLIC_URL}/images/image33.jpg`,
      `${process.env.PUBLIC_URL}/images/image34.jpg`
    ],
  ...
  },
  {
    ...
    images: [
      `${process.env.PUBLIC_URL}/images/image36.jpg`,
      `${process.env.PUBLIC_URL}/images/image37.jpg`,
      `${process.env.PUBLIC_URL}/images/image38.jpg`,
      `${process.env.PUBLIC_URL}/images/image39.jpg`,
      `${process.env.PUBLIC_URL}/images/image40.jpg`,
      `${process.env.PUBLIC_URL}/images/image41.jpg`,
      `${process.env.PUBLIC_URL}/images/image42.jpg`
    ],
    floorPlan: `${process.env.PUBLIC_URL}/images/image43.jpg`
  },
  {
    id: 6,
    type: 'flat',
    ...
    images: [
      `${process.env.PUBLIC_URL}/images/image44.jpg`,
      `${process.env.PUBLIC_URL}/images/image45.jpg`,
      `${process.env.PUBLIC_URL}/images/image46.jpg`,
      `${process.env.PUBLIC_URL}/images/image47.jpg`,
      `${process.env.PUBLIC_URL}/images/image48.jpg`,
      `${process.env.PUBLIC_URL}/images/image49.jpg`,
      `${process.env.PUBLIC_URL}/images/image50.jpg`
    ],
    floorPlan: `${process.env.PUBLIC_URL}/images/image51.jpg`
  },
  {
    id: 7,
    type: 'house',
    ...
    images: [
      `${process.env.PUBLIC_URL}/images/image52.jpg`,
      `${process.env.PUBLIC_URL}/images/image53.jpg`,
      `${process.env.PUBLIC_URL}/images/image54.jpg`,
      `${process.env.PUBLIC_URL}/images/image55.jpg`,
      `${process.env.PUBLIC_URL}/images/image56.jpg`,
      `${process.env.PUBLIC_URL}/images/image57.jpg`,
      `${process.env.PUBLIC_URL}/images/image58.jpg`
    ],
    floorPlan: `${process.env.PUBLIC_URL}/images/image59.jpg`
  }
];